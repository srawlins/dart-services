...
ARG FLUTTER_COMMIT=2783f8e2e14efec8b7e08f668dde61c40d128c24
...
RUN wget https://storage.googleapis.com/dart-archive/channels/dev/release/2.11.0-240.0.dev/sdk/dartsdk-linux-x64-release.zip
